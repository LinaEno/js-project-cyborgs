parcelRequire = (function (init) {
            ...
            dataKeys.forEach(function (key) {
              ...
              if (isColor) {
                ...
                controller = folder.add.apply(
                  folder,
                  [datData, key].concat($IDtB$var$_toConsumableArray(guiRange))
                );
              }
    ...
    (function () {
      function Animation(fn, options) {
        ...
        var _options$begin2 = options.begin,
          ...
          easing =
            _options$easing2 === void 0 ? 'easeInOutCubic' : _options$easing2,
  ...
  function $vFOr$export$getTextCoordinate(option) {
    ...
    textLines.forEach(function (text, i) {
      var x = width / 2;
      var y =
        height / 2 + fontSize * i - (fontSize / 2) * (textLines.length - 1);
  ...
  var $m6Ky$export$default =
    ...
    (function () {
      function Text() {
        ...
        var textNormalWidth =
          $m6Ky$var$TEXT.length + letterSpacing * ($m6Ky$var$TEXT.length - 1);
  ...
  var $Focm$var$WebGL =
    ...
    (function () {
      function WebGL(_ref) {
        ...
        var initialClientWidth = ($mrfc$export$default.initialClientWidth =
